...
void Frameless::setPadding(int padding)
{
    this->padding = padding;
}

void Frameless::setMoveEnable(bool moveEnable)
{
    this->moveEnable = moveEnable;
}

void Frameless::setResizeEnable(bool resizeEnable)
{
    this->resizeEnable = resizeEnable;
}

void Frameless::setWidget(QWidget *widget)
{
    if (this->widget == nullptr && widget != nullptr) {
        this->widget = widget;
        // 设置鼠标追踪为真
